...
public class Withdraw extends JFrame  implements ActionListener {
    ...
    Withdraw(String pinnumber) {
        ...
        JLabel textDeposit = new JLabel("Enter the amount you want to withdraw");
        textDeposit.setForeground(Color.white);
        textDeposit.setFont(new Font("System", Font.BOLD, 16));
        textDeposit.setBounds(170, 300, 400, 20);
        image.add(textDeposit);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() ==  withdraw){
            ...
            if(number.equals("")){
                JOptionPane.showMessageDialog(null, "Please enter the a,mount you want to deposit");
            } else {
                try {
