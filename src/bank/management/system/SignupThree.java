...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        JLabel l1 = new JLabel("Page 3: Account Details (BIB)");
        ...
        r1 = new JRadioButton("Checking Account");
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-8157");
        ...
        c7 = new JCheckBox("I certify that all the information I have provided in support of my application form is true and accurate.");
    ...
    public void actionPerformed(ActionEvent ae) {     
        if (ae.getSource() == submit){
            ...
            // Generates random number for cardnumber and pin number 
